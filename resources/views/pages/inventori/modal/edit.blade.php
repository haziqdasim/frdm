                ...
                <div class="row">
                    <div class="col-md-12 fv-row mb-7">
                        ...
                        <div class="input-group mb-5">
                            ...
                            <input type="text" class="form-control" placeholder="Scan tag RFID anda" value="#342523312" disabled aria-label="rfid-number" aria-describedby="basic-addon1" id="rfidInput" />
