<div class="modal fade" tabindex="-1" id="tambah-lori">
            ...
            <div class="modal-body">
                <div class="row my-10">
                    <div class="col-md-6 fv-row mb-7">
                        ...
                        <input type="text" onkeyup="this.value = this.value.toUpperCase();" class="form-control" placeholder="Masukkan nombor pendaftaran" name="reg-num" value="">
                    ...
                    <div class="col-md-6 fv-row mb-7">
                        ...
                        <input class="form-control" placeholder="Pilih tarikh" id="tarikh-luput-cukai-jalan"/>
                    </div>

                    <div class="col-md-6 fv-row mb-7">
                        <label for="" class="required form-label">Servis seterusnya</label>
                        <input class="form-control" placeholder="Pilih tarikh" id="servis-seterusnya"/>
                    </div>
